...
""" I find it interesting that monkey has a higher similarity to banana than cat even though they are both animals."""
...
print("\n")
tokens = nlp("dog eel bone")

for token1 in tokens:
    for token2 in tokens:
        (print(token1.text,token2.text,token1.similarity(token2)))

# 'dog' has a higher similarity to 'bone' than 'eel' does, but 'dog' and 'eel' are more similar.
